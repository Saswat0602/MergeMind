      ...
      <div className="relative max-w-7xl mx-auto px-6 py-10 z-10">
        ...
        <header className="flex justify-between items-center mb-12">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/settings"
              className="px-4 py-2 text-sm bg-white/5 border border-white/10 hover:bg-white/10 hover:border-violet-500/30 text-slate-200 rounded-lg backdrop-blur-md transition-all duration-300 flex items-center gap-2"
            >
